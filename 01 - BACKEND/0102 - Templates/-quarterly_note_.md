...
// AUTO-MOVE THE FILE
await tp.file.move(`11 - PRIVATE/1102 - Journal/${year}/Quarterly Notes/${year}-Q${quarterNum}`);
...
Quarterly_Link: "[[11 - PRIVATE/1102 - Journal/${year}/04 - Quarterly Notes/${year}-Q${quarterNum}]]"
aliases:
  - "Q${quarterNum} ${year}"
tags:
  - quarterly-note
...
**YEAR:** [[11 - PRIVATE/1102 - Journal/${year}/${year}|${year}]] • **QUARTER:** [[11 - PRIVATE/1102 - Journal/${year}/Quarterly Notes/${year}-Q${quarterNum}|${year}-Q${quarterNum}]]
...
const monthlyNotesPath = `11 - PRIVATE/1102 - Journal/${year}/Qua Notes`;
